        ...
        <div class="container">
            <div class="row">
                ...
                <div class="button-group" style="margin-top: 20px;">
                    <a href="#sign-up" class="btn" style="display: inline-block; padding: 10px 20px; font-size: 16px; color: black; background-color: white; text-decoration: none; border-radius: 5px; margin-right: 10px; border: 1px solid black;">
                        Sign Up to Drive
                    </a>
